...
def prepare_context(data: Dict[str, List[Dict[str, Any]]], max_items: int = 20) -> str:
...
def fallback_analysis(data: Dict[str, List[Dict[str, Any]]], query: str) -> Dict[str, Any]:
    """Fallback analysis without LLM."""
    def get_top_items(data: Dict[str, List[Dict[str, Any]]]) -> List[str]:
    ...
    return {
        ...
        "notable_items": get_top_items(data),
        "recommendations": [
...
class GroqAnalyzer:
    ...
    def analyze(self, data: Dict[str, List[Dict[str, Any]]], query: str) -> Dict[str, Any]:
        ...
        if not self.client:
            ...
            return fallback_analysis(data, query)
